            ...
            if(counter>5 && counter<15){
              ...
              wb_motor_set_velocity(l2,-1.0);
                ...
                if(counter>15 && counter<40){
                  ...
                  wb_motor_set_velocity(l4,-1.5);
                  }
                    if(counter>40 && counter<45){
                      wb_motor_set_velocity(l3,0.0);
                      wb_motor_set_velocity(l4,0.0);
                      wb_motor_set_velocity(l5,0.5);
                      }
                        if(counter>45 && counter<55){
                          wb_motor_set_velocity(l5,0.0);
                          wb_motor_set_velocity(l6,0.5);
                          }
                            if(counter>60 && counter<67){
                              wb_motor_set_velocity(l2,-0.5);
                              }
                                if(counter>97 && counter<105){
                                  wb_motor_set_velocity(l3,2.5);
                                  wb_motor_set_velocity(l2,0.5);
                                  }
                                    if(counter>105){
                                      wb_motor_set_velocity(l2,0.0);
